...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const drawIntroText = () => {
    ...
    const pathosIntroMessage = "<span>Unhappy</span>, <span>angry</span>, <span>distracted</span>, or <span>misled</span> by social media? Compelled to click the notification button or scroll the newsfeed? Companies such as facebook employ engineers to make their platform as addictive as possible.<span class='notifhighlight' id='notyourfault'> Read the sources! It's not your fault if you feel bad!</span>";
